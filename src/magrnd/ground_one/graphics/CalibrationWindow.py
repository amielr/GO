...
class CalibrationWindow:
    ...
    def cut_calibration_part_from_scan_using_automated_method(self, path):
        # load IA raw data of a calibration scan
        # cut only the part of the calibration
        # returns GZ_ia_matrix of the selected part
        ...
        cutbx, cutby, cutbz = self.cut_data
        ...
        # plot magnetic data from calib file
        self.axes[0].plot(bx, linewidth=2, color="r")
        self.axes[0].plot(by, linewidth=2, color="g")
        self.axes[0].plot(bz, linewidth=2, color="b")
        self.axes[0].set_xlabel('Index', fontsize=16)
        self.axes[0].set_ylabel('Sensor Value [V]', fontsize=16)
        self.axes[0].grid()

        self.axes[1].plot(cutbx, linewidth=2, color="r")
        self.axes[1].plot(cutby, linewidth=2, color="g")
        self.axes[1].plot(cutbz, linewidth=2, color="b")
        self.axes[1].set_xlabel('Index', fontsize=16)
        self.axes[1].set_ylabel('Sensor Value [V]', fontsize=16)
        self.axes[1].grid()
